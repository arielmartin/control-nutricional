...
<html>
	...
	<body>
		...
		<div class = "main container">
			...
			<div id="plan"  class="mainbox col-md-8 col-md-offset-2 col-sm-12">	
				...
				<form:form action="progresoPaciente" method="POST" modelAttribute="pacienteDTO">
					...
					<div id="grafico"  class="mainbox col-md-12 col-sm-12">	
					<br>
						...
						<div   class="mainbox col-md-8 col-sm-8">	
							<!--  <div class="mainbox">-->
							<br>
						...
						<div   class="mainbox col-md-4 col-sm-4" style="margin-top:8em;">
